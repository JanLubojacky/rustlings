...
fn count_iterator(map: &HashMap<String, Progress>, value: Progress) -> usize {
    ...
    // or alterntative using filter
    // values gives reference and closure passed to filter
    // takes reference as well so we get reference to a reference
    // it is common to destruct it in the closure to not have to use double dereference
